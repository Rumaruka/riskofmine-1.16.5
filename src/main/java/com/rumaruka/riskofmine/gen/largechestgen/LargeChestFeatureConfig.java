...
public class LargeChestFeatureConfig implements IFeatureConfig {
    ...
    public static class Builder {
        ...
        public LargeChestFeatureConfig.Builder whitelist(Set<Block> set_) {
            this.whitelist = set_;
            return this;
        }

        public LargeChestFeatureConfig.Builder blacklist(Set<BlockState> set_) {
            this.blacklist = set_;
            return this;
        }

        public LargeChestFeatureConfig.Builder tries(int int_) {
            this.tries = int_;
            return this;
        }


        public LargeChestFeatureConfig.Builder xspread(int int_) {
            this.xspread = int_;
            return this;
        }

        public LargeChestFeatureConfig.Builder yspread(int int_) {
            this.yspread = int_;
            return this;
        }

        public LargeChestFeatureConfig.Builder zspread(int int_) {
            this.zspread = int_;
            return this;
        }

        public LargeChestFeatureConfig.Builder canReplace() {
            this.canReplace = true;
            return this;
        }

        public LargeChestFeatureConfig.Builder noProjection() {
            this.project = false;
            return this;
        }

        public LargeChestFeatureConfig.Builder needWater() {
            this.needWater = true;
            return this;
        }
