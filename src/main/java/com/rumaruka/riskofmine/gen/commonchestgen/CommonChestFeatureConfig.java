package com.rumaruka.riskofmine.gen.commonchestgen;
...
public class CommonChestFeatureConfig implements IFeatureConfig {
    public static final Codec<CommonChestFeatureConfig> CODEC = RecordCodecBuilder.create((instance_) -> {
        ...
        })).apply(instance_, CommonChestFeatureConfig::new);
    ...
    private CommonChestFeatureConfig(BlockStateProvider blockStateProvider_, BlockPlacer blockPlacer_, List<BlockState> list_, List<BlockState> list1_, int int_, int int1_, int int2_, int int3_, boolean boolean2_, boolean boolean_, boolean boolean1_) {
    ...
    private CommonChestFeatureConfig(BlockStateProvider stateProvider, BlockPlacer blockPlacer, Set<Block> whitelistIn, Set<BlockState> set_, int int_, int int1_, int int2_, int int3_, boolean boolean2_, boolean boolean_, boolean boolean1_) {
    ...
    public static class Builder {
        ...
        public CommonChestFeatureConfig.Builder whitelist(Set<Block> set_) {
            this.whitelist = set_;
            return this;
        }

        public CommonChestFeatureConfig.Builder blacklist(Set<BlockState> set_) {
            this.blacklist = set_;
            return this;
        }

        public CommonChestFeatureConfig.Builder tries(int int_) {
            this.tries = int_;
            return this;
        }


        public CommonChestFeatureConfig.Builder xspread(int int_) {
            this.xspread = int_;
            return this;
        }

        public CommonChestFeatureConfig.Builder yspread(int int_) {
            this.yspread = int_;
            return this;
        }

        public CommonChestFeatureConfig.Builder zspread(int int_) {
            this.zspread = int_;
            return this;
        }

        public CommonChestFeatureConfig.Builder canReplace() {
            this.canReplace = true;
            return this;
        }

        public CommonChestFeatureConfig.Builder noProjection() {
            this.project = false;
            return this;
        }

        public CommonChestFeatureConfig.Builder needWater() {
            this.needWater = true;
            return this;
        }

        public CommonChestFeatureConfig build() {
            return new CommonChestFeatureConfig(this.stateProvider, this.blockPlacer, this.whitelist, this.blacklist, this.tries, this.xspread, this.yspread, this.zspread, this.canReplace, this.project, this.needWater);
        }
    }
}
