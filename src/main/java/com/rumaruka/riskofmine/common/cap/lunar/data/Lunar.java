...
public class Lunar extends PropertyContainer {
    ...
    public static float getMaxLunar(PlayerEntity player) {
    ...
    public void addLunar(PlayerEntity player, float add) {
        setLunar(Math.min(getCurrentLunar() + add, getMaxLunar(player)));
    }

    public boolean consumeLunar(PlayerEntity player, float price) {
