...
@OnlyIn(Dist.CLIENT)
public class BaseShopScreen extends ContainerScreen<ChestShopInventory> implements IHasContainer<ChestShopInventory> {
    ...
    public BaseShopScreen(ChestShopInventory container, PlayerInventory playerInventory, ITextComponent title) {
