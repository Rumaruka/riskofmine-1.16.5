...
public class MoneySetCommand {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher){
        ...
        }).then(Commands.literal("set").then(Commands.argument("targets", EntityArgument.players()).then(Commands.argument("amount", FloatArgumentType.floatArg()).executes((p_198445_0_) -> {
            return setMoney(p_198445_0_.getSource(), EntityArgument.getPlayers(p_198445_0_, "targets"), FloatArgumentType.getFloat(p_198445_0_, "amount"));
    })))));
